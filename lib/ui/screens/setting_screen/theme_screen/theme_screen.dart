          ...
          child: Column(
            children: [
              ...
              Row(
                children: [
                  Expanded(
                    child: ThemeImageWidget('assets/images/blueThem.png',
                        defaultBlueColor, textGreenTheme, 0),
                  ),
                  const SizedBox(width: 15),
                  Expanded(
                    child: ThemeImageWidget('assets/images/greenTheme.jpg',
                        defaultGreenColor, textGreenTheme, 1),
                  ),
                  const SizedBox(width: 15),
                  Expanded(
                      child: ThemeImageWidget('assets/images/orange.jpg',
                          defaultColor, textOrangeTheme, 3)),
                ],
              ),
              const Spacer(
                flex: 1,
