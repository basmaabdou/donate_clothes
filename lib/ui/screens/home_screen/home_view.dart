...
class _HomeScreenState extends State<HomeView> {
  List<ImageModel> imageItems = [
    ImageModel(image: 'assets/images/p11.avif'),
    ImageModel(image: 'assets/images/p10.avif'),
    ImageModel(image: 'assets/images/p8.avif'),
    ImageModel(image: 'assets/images/p4.jpg'),
    ImageModel(image: 'assets/images/p5.avif'),
    ImageModel(image: 'assets/images/p6.avif'),
    ImageModel(image: 'assets/images/p7.avif'),
    ImageModel(image: 'assets/images/p9.avif'),
    ImageModel(image: 'assets/images/p2.jpg'),
    ImageModel(image: 'assets/images/p1.avif'),
  ];
                        ...
                        Positioned(
                          ...
                          child: Container(
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                children: [
                                  Text('30%',textAlign: TextAlign.center,style: TextStyle(fontSize: 16,fontWeight: FontWeight.bold,color: Colors.black),),
                                  Row(
                                    children: [
                                      Text('50%',style: TextStyle(fontSize: 16,fontWeight: FontWeight.bold,color: Colors.black),),
                                      SizedBox(width: 8,),
                                      Text("SALE",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 22,color: defaultColor),),
                                      SizedBox(width: 8,),
                                      Text('40%',style: TextStyle(fontSize: 16,fontWeight: FontWeight.bold,color: Colors.black),),
                                    ],
                                  ),
                                  Row(
                                    children: [
                                      SizedBox(width: 25,),
                                      Text('70%',style: TextStyle(fontSize: 16,fontWeight: FontWeight.bold,color: Colors.black),),
                                      SizedBox(width: 25,),
                      ...
                      children: [
                        Container(
                          ...
                          decoration: BoxDecoration(
                            borderRadius: BorderRadius.circular(10),
                            image: DecorationImage(
                              image: AssetImage('assets/images/s1.avif'),
                              fit: BoxFit.fill,
                            ),
                          ),
                        ),
                      ...
                      children: [
                        Container(
                          ...
                          decoration: BoxDecoration(
                            borderRadius: BorderRadius.circular(10),
                            image: DecorationImage(
                              image: AssetImage('assets/images/s2.avif'),
                              fit: BoxFit.fill,
                            ),
                          ),
                        ),
              ...
              Container(
                ...
                child: ListView.separated(
                  ...
                  itemBuilder: (context, index) =>
                      BuildImage(ImageModel(image: imageItems[index].image)),
